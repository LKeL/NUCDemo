...
//        startActivity(intent);
        ...
        Uri loginUri = Uri.parse("https://coding.net/oauth_authorize.html?client_id=06845b1f1a3f55dfd6a2201ccb7eb99b" +
                "&redirect_uri=http://127.0.0.1:5000/&response_type=code&scope=user");
        mWebView.loadUrl(String.valueOf(loginUri));
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                if (Uri.parse(url).getQueryParameter("code") != null) {
                    setContentView(R.layout.activity_login);
                    final String[] access_token = new String[1];
                    String code = Uri.parse(url).getQueryParameter("code");
                    String tokenUrl = "https://coding.net/api/oauth/access_token?client_id=06845b1f1a3f55dfd6a2201ccb7eb99b&client_secret=" +
                            "261a1b886fe817268e7f108624cba9de5c9ec4af&grant_type=authorization_code&code=" + code;
                    //get获取access_token
                    AsyncHttpClient client = new AsyncHttpClient();
                    client.get(tokenUrl, new JsonHttpResponseHandler() {
                        @Override
                        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                            ...
                            try {
                                ...
                                temp.get("https://coding.net/api/current_user?access_token=" + access_token[0], new JsonHttpResponseHandler() {
                                    @Override
                                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                                        Log.v("测试", "----------------------------------------------------------");
        ...
        Log.v("测试专用", "------------------------");
        Log.v("测试专用", "this is a sign in test");
        Log.v("测试专用", "------------------------");
    }
...
//        }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.heartblood.nucdemo/http/host/path")
        );
